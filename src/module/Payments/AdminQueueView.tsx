...
export const AdminQueueView = () => {
                      ...
                      >
                        ...
                        <td className="px-6 py-2 cursor-pointer">
                          {action === queues.id && (
                            <div
                              ref={actionRef}
                              className="z-10 cursor-pointer absolute mt-[1.6rem] ml-[-3.5rem] bg-white divide-y divide-gray-100 rounded-lg shadow w-[7rem] dark:bg-gray-700"
                            >
                              <ul
  ...
  hover:bg-rose-200 cursor-pointer"
      ...
      hover:bg-emerald-200 cursor-pointer"
                            ...
                            <div
                              onClick={() =>
                                handlePrintQueue(queues.que_number)
                              }
                              className="inline-flex items-center justify-center px-3 py-1.5
    bg-blue-100 text-gray-700 rounded-full
