...
export interface ServingTableResultViewModel
  extends TableViewModel, ResultViewModel {
  data: ServingViewModel[];
}

export interface ServingResultViewModel extends ResultViewModel {
  data: ServingViewModel;
}

export interface ServingListResultViewModel extends ResultViewModel {
  data: ServingViewModel[];
}

export const ServingDefaultValue: ServingViewModel = {
...
export const ServingTableDefaultValue: ServingTableResultViewModel = {
  data: [],
  page: 1,
  pageSize: 10,
  total: 0,
